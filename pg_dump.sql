...
CREATE USER ticker WITH PASSWORD 'ticker';


GRANT ALL ON DATABASE ticker TO ticker;
...
GRANT ALL ON TABLE public.prices TO ticker;
...
GRANT ALL ON SEQUENCE public.prices_id_seq TO ticker;
